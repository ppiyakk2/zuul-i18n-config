...
| 항목 | 값 |
|------|---|
| 내부 IP (Zuul → 노드) | <WORKER_INTERNAL_IP> |
| 외부 IP (개발자 접속) | <WORKER_HOST_IP> |
| OS | Ubuntu 24.04.3 LTS |
| Python | 3.12 |
| User | ubuntu |
| SSH Key | ~/.ssh/your-worker-key.pem |
...
cat /home/ubuntu/zuul-test/keys/nodepool_rsa.pub | \
  ssh ubuntu@<WORKER_INTERNAL_IP> "cat >> ~/.ssh/authorized_keys"
```
...
**증상**: `No such file or directory: /home/ubuntu/src/github.com/<your-org>/contributor-guide`
